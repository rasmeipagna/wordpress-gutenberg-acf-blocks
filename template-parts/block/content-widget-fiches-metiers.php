                ...
                <div class="pictos-domaines">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <img class="center domaines" src="<?php the_field('image_sante'); ?>" />
                            </a>
                            <a href="<?php the_field('energie'); ?>">
                            <img class="center domaines" src="<?php the_field('image_energie'); ?>" />
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <img class="center domaines" src="<?php the_field('image_cosmetique'); ?>" />
                            </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="fiches-metiers-button"><a href="<?php the_field('lien'); ?>"><?php the_field('intitule_du_bouton'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
